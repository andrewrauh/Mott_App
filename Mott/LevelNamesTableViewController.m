//
//  LevelNamesTableViewController.m
//  Mott
//
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *firstName = [firstNamesL objectAtIndex:indexPath.row];
    NSLog(@"First Name of cell: %@",firstName);
    NSString *lastName = [lastNamesL objectAtIndex:indexPath.row];
    NSLog(@"Last Name of cell: %@",lastName);
    NSString *level = [levelsL objectAtIndex:indexPath.row];
    NSString *room = [roomsL objectAtIndex:indexPath.row];
    NSString *picturePath = [picLocL objectAtIndex:indexPath.row];
